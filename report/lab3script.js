export const lab3Info = {
  ...
  template_task: "./assets/lab3/template.png",
  tableTask: {
    fixed_table: "./assets/lab3/fixedTable.png",
    rubber_table: "./assets/lab3/rubberTable.png",
  },
  flexTask: {
    page_screen: "",
    page_html: "",
...
export function setupSecondLabView() {
  ...
  fixedTableDiv.innerHTML = "Фіксована таблична верстка";
  ...
  rubberTableDiv.innerHTML = "Фіксована болокова верстка";
...
export function showFixedTable() {
  ...
  let img = document.createElement("img");
  img.src = lab3Info.tableTask.fixed_table;
  img.style.width = "1000px";
  img.style.objectFit = "scale-down";
...
export function showRubberTable() {
  ...
  let img = document.createElement("img");
  img.src = lab3Info.tableTask.rubber_table;
  img.style.width = "1000px";
  img.style.objectFit = "scale-down";
...
export function showFlexScreen() {
  ...
  let img = document.createElement("img");
  img.src = lab3Info.flexTask.page_screen;
  img.style.width = "1000px";
  img.style.objectFit = "scale-down";
...
export function showFlexHtml() {
  ...
  let img = document.createElement("img");
  img.src = lab3Info.flexTask.page_html;
  img.style.width = "1000px";
  img.style.objectFit = "scale-down";
...
export function showFlexCss() {
  ...
  let img = document.createElement("img");
  img.src = lab3Info.flexTask.page_css;
  img.style.width = "1000px";
  img.style.objectFit = "scale-down";
